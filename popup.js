...
function getCurrentTabUrl(callback) {
  ...
  // function addButtonToPage(tab) {
  //   if (tab.url.startsWith("https://w.amazon.com")) {
  //     chrome.tabs.sendMessage(tab.id, {text: 'abc'}, xyz);
  //   }
  // }
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  chrome.storage.local.get('data', function(data) {
    ...
    data.data.forEach(function(linkObj) {
      document.getElementById('links').innerHTML += ('<a style="display: block; margin: 3px;" href="' + linkObj.name + '">' + linkObj.name + '</a>');
    });
